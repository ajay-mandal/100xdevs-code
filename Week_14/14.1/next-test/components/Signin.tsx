...
export default function SigninComponent() {
    return <div className="h-screen flex justify-center flex-col">
        ...
        <a href="#" className="block w-[380px] p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 ">
                <div>
                    <div className="px-10">
                    ...
                    <div className="pt-2">
                        <LabelledInput label="Username" placeholder="ajay@zexacorp.io" />
